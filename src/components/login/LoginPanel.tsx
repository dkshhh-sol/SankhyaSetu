...
export function LoginPanel() {
  ...
  return (
    <section className="flex flex-col bg-surface px-5 py-6 sm:px-8 lg:h-full lg:min-h-0 lg:px-8 lg:py-3">
      {/* Ministry lockup */}
      ...
      <div className="flex flex-1 items-center justify-center py-3 lg:min-h-0">
        <div className="scrollbar-thin flex w-full max-w-[560px] flex-col rounded-2xl border border-slate-200/80 bg-white p-5 shadow-pop sm:p-6 lg:max-h-full lg:overflow-y-auto">
          ...
          {/* Prototype notice */}
          <div className="flex gap-2.5 rounded-xl bg-brand-50 p-3 text-sm text-ink-soft">
          ...
          {/* Demo accounts */}
          <h3 className="mt-4 text-sm font-semibold text-ink">Demo Accounts</h3>
