...
export function LoginPanel() {
  ...
  return (
    <section className="flex min-h-full flex-col bg-surface px-5 py-8 sm:px-8 lg:px-12 lg:py-10">
      {/* Ministry lockup */}
      ...
      <div className="flex flex-1 items-center justify-center py-8">
        <div className="w-full max-w-[600px] rounded-3xl border border-slate-200/80 bg-white p-6 shadow-pop sm:p-9">
          <h2 className="font-display text-2xl font-extrabold tracking-tight text-ink sm:text-[32px]">
            Welcome to <span className="text-brand-600">SankhyaSetu</span>
          </h2>
          <p className="mt-1.5 text-base text-ink-muted sm:text-lg">
          ...
          >
            <span className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
              {pending === "sso" ? (
                ...
                <Fingerprint className="size-7 text-[#e07b1a]" aria-hidden />
              )}
            </span>
          ...
          {/* Prototype notice */}
          <div className="flex gap-3 rounded-2xl bg-brand-50 p-4 text-sm text-ink-soft">
          ...
          {/* Demo accounts */}
          <h3 className="mt-6 text-base font-bold text-ink">Demo Accounts</h3>
