...
export function HeroPanel() {
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-b from-[#f3f7fd] via-[#eaf1fb] to-[#e6edf6] [container-type:inline-size]">
      {/* Sky glow */}
      ...
      <div className="relative z-10 flex min-h-full flex-col px-6 pt-8 sm:px-10 sm:pt-10 lg:px-14 lg:pt-12">
        {/* Brand + strapline */}
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          <Logo wordmarkClassName="text-2xl sm:text-[28px]" />
          <div className="hidden h-11 w-px bg-ink/15 sm:block" />
        ...
        <div className="mt-10 max-w-xl lg:mt-14">
          <h1 className="font-display text-[44px] font-extrabold leading-[1.02] tracking-tight text-ink sm:text-6xl lg:text-[72px]">
            Empowering
            <br />
            People Behind
            <br />
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-ink-soft sm:text-lg lg:text-[19px]">
        ...
        {/* Feature badges */}
        <div className="mt-8 flex flex-wrap gap-x-4 gap-y-6 sm:gap-x-8 lg:mt-10">
          {FEATURES.map((f) => (
        ...
        <div className="relative mt-8 -mx-6 sm:-mx-10 lg:-mx-14 lg:mt-auto">
          <img
